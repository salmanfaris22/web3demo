...
import classes from "./Dexgem.module.scss";
...
import { getDexGemOverview } from "../../../../../services/overview";
...
const DexGem = () => {
  ...
  const getDexgemSummary = async () => {
    setFetching(true);
    try {
      let filter = `?period=${filterApplied}`;
      const response = await getDexGemOverview(filter);
      if (response.status) {
        if (response.data) {
          const total =
              ...
              <div className={classes.autoWrap}>
                <div className={classes.topSection}>
                  <div className={classes.totalTop}>
                    <div className={classes.totalHead}>Dexgem</div>
                  ...
                  <div className={classes.autoOverview}>
                    ...
                    <div className={classes.nameProgress}>
                      <div className={classes.left}>
                        <div className={classes.name}>Active</div>
                        <div className={classes.progressOut}>
                          <div
                            className={`${classes.progressIn} ${classes.progressPayout}`}
                            style={{
                              width: `${summary.percent.activePercent}%`,
                            }}
                          ></div>
                        </div>
                      </div>
                    ...
                    <div className={classes.nameProgress}>
                      <div className={classes.left}>
                        <div className={classes.name}>Deactive</div>
                        <div className={classes.progressOut}>
                          <div
                            className={`${classes.progressIn} ${classes.progressPayout}`}
                            style={{
                  ...
                  <div className={classes.newOld}>
                    <div className={classes.newOldItemWrap}>
                      ...
                      <div className={classes.newOldRight}>
                        <div className={classes.val}>
                          {summary.new_users_change}
                        </div>
                        <div className={classes.arrowWrap}>
                          <div
                            className={`${classes.arrow} ${
                              summary.new_users_change > 0 && classes.arrowGreen
                            }`}
                          >
                            {summary.new_users_change > 0 ? (
                              <img
                    ...
                    <div className={classes.newOldItemWrap}>
                      ...
                      <div className={classes.newOldRight}>
                        <div className={classes.val}>
                          {summary.old_users_change}
                        </div>
                        <div className={classes.arrowWrap}>
                          <div
                            className={`${classes.arrow} ${
                              summary.old_users_change > 0 && classes.arrowGreen
                            }`}
                          >
                            {summary.old_users_change > 0 ? (
                              <img
                                src="/assets/images/upArrow.png"
                                alt="arrow"
                              />
